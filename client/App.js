...
const HomeScreen = ({ navigation }) => (
  <View style={styles.container}>
    ...
    <CustomButton title="RegistrationForm" onPress={() => navigation.navigate('RegistrationForm')} />
    <CustomButton title="BMI" onPress={() => navigation.navigate('BMI')} />

    {/* <CustomButton title="BMI"  /> */}
  </View>
);
